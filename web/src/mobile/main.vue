<template>
  <div class="page-container">
    ...
    <!-- <div class="choose-panel">
      <button class="ctrl-btn" title="菜单">
        <button class="ctrl-btn">
          最开始想的是在右边再做个按钮像地图那种界面，但感觉不合适放搜索框里面吧
        </button>
      </button>
    </div> -->
    ...
    <!-- <div class="dropup-container">
      <div class="dropup-list-container">
        <div class="dropdown-list-wrapper">
          <ul class="dropdown-list"></ul>
          <div class="floating-icon" aria-hidden="true"></div>
        </div>
      </div>
      <div class="dropup-search-box">
        ...
        <input id="searchID" placeholder="例如：感冒" v-model="diseaseKeyword" @keyup.enter="handleSearch"
